...
var HIDDEN_CLASSNAME = "hidden"; // 문자열 타입을 변수로 만든 이유 -> 오타로 인한 오류 방지
...
var savedUsername = localStorage.getItem(USERNAME_KEY); //localStorage.setItem("key","value"), getItem("key"),removeItem("key")
